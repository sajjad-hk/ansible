...
#
# For systems that do not have "hostname -I" use bellow command for Internal IP.
# `ifconfig eth0 | grep "inet" | gawk -F: '{print $2}' | gawk '{print $1}'`
##################################################
...
#STORE=`df -h /storage | awk '{ a = $4 } END { print a }'`
##################################################
# Load Data Capture
#
...
\033[0;35m+\033[0;37mDisk Space Available - root \033[0;35m= \033[1;34m$ROOT \033[0;37mstore \033[0;35m= \033[1;34m$STORE
